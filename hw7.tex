...
\begin{questions}
  ...
  \begin{parts}
    ...
    \begin{solution}
	    I will show that this problem is a generalization of Independent Set. \\
	    Construct a graph with vertices for each of the n elements of E and
	    vertices for each of the m subsets of E such that variable vertices
	    have edges connecting them to each of the subsets they are in. 
	    Given a graph G and an integer k, determine if G has an independent set of size $\geq$ k. 
    \end{solution}
